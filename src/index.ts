...
# generated by ${url}
# Usage: add the following to your Gitpod file
#   tasks:
#     - name: Gitpod installer (${tasks?.replaceAll(" ", ", ")})
#       before: curl -s ${base}/before${tasksParam} | bash
#       init: curl -s ${base}/init${tasksParam} | bash
#       command: curl -s ${base}/command${tasksParam} | bash
